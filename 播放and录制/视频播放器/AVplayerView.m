...
- (void)setPlayLayer
{
    _contentPlayView = [[PlayView alloc] initWithFrame:self.bounds];
    ...
    [self addSubview:_contentPlayView];
...
- (void)setSubviews
{
    ...
    [self.contentPlayView addSubview:self.playToolBar];
...
- (void)addGestureRecognizers
{
    ...
    [self.contentPlayView addGestureRecognizer:tap];

    [self.contentPlayView addGestureRecognizer:pinch];
}
#pragma mark - show
- (void)show
{
    ...
    [keyWindow addSubview:self.contentPlayView];
    self.contentPlayView.transform = CGAffineTransformMakeScale(0.5, 0.5);
    ...
    [UIView animateWithDuration:0.3
         ...
         usingSpringWithDamping:0.4
          initialSpringVelocity:0
                     ...
                     animations:^{
                         weakself.contentPlayView.transform = CGAffineTransformMakeScale(1, 1);
                     }
...
- (AVplayerView * (^)())showInView
{
    ...
    return ^AVplayerView *(){
        ...
        weakself.contentPlayView.transform = CGAffineTransformMakeScale(0.5, 0.5);
...
- (UIButton*)videoPlay
{
    if (!_videoPlay) {
        ...
        _videoPlay.backgroundColor = [UIColor orangeColor];
    }
    return _videoPlay;
}
